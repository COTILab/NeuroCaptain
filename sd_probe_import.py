...
class NEUROCAPTAIN_OT_import_sd_probe(Operator, ImportHelper):
    ...
    def execute(self, context):
        try:
            ...
            for i, pos in enumerate(src_pos_3d):
                ...
                # Move to Sources collection
                self.move_to_collection(optode, sources_collection)
            ...
            for i, pos in enumerate(det_pos_3d):
                ...
                # Move to Detectors collection
                self.move_to_collection(optode, detectors_collection)
    ...
    def move_to_collection(self, obj, target_collection):
        """Move object to target collection and remove from others"""
