...
class dual_mesh(Operator):
    ...
    polygon_method: EnumProperty(
        items=[
            ...
            ("CLIP", "Clip", "Split the N-gon with an ear clipping algorithm"),
        ],
        name="N-gon Method",
    ...
    preserve_borders: BoolProperty(
        name="Preserve Borders", default=True, description="Preserve original borders"
    )
    apply_modifiers: BoolProperty(
        name="Apply Modifiers", default=True, description="Apply object's modifiers"
    )
    ...
    def execute(self, context):
        ...
        for ob0 in sel:
            ...
            bpy.ops.mesh.select_mode(
                use_extend=False, use_expand=False, type="VERT", action="TOGGLE"
            )
